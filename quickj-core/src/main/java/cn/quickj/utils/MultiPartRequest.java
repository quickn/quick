...
public abstract class MultiPartRequest {
	...
	/**
	 * Returns <tt>true</tt> if the request is multipart form data,
	 * <tt>false</tt> otherwise.
	 * 
	 * @param request
	 *            the http servlet request.
	 * @return <tt>true</tt> if the request is multipart form data,
	 *         <tt>false</tt> otherwise.
	 */
	...
	/**
	 * Returns a list of error messages that may have occurred while processing
	 * the request. If there are no errors, an empty list is returned. If the
	 * underlying implementation (ie: pell, cos, jakarta, etc) cannot support
	 * providing these errors, an empty list is also returned. This list of
	 * errors is repoted back to the {@link MultiPartRequestWrapper}'s errors
	 * field.
	 * 
