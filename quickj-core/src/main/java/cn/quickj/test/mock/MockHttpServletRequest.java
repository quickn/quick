...
public class MockHttpServletRequest implements HttpServletRequest {
	...
	private final Map<String, HeaderValueHolder> headers = new cn.quickj.utils.LinkedCaseInsensitiveMap<HeaderValueHolder>();
	...
	public MockHttpServletRequest(ServletContext servletContext, String method, String requestURI) {
		this.servletContext = null;//(servletContext != null ? servletContext : new MockServletContext());
		this.method = method;
